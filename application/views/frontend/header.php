...
<body class="animsition">
  ...
  <header class="header1">
    ...
    <div class="container-menu-header" id="header">
      <div class="topbar">
        <div class="topbar-social">
          <a href="https://www.instagram.com/selma.indonesia/" class="topbar-social-item fa fa-instagram"></a>
        </div>
      ...
      <div class="wrap_header">
        <!-- Logo -->
        <a href="<?= base_url('Frontend'); ?>" class="logo">
    ...
    <div class="wrap_header_mobile">
      <!-- Logo moblie -->
      <a href="<?= base_url('Frontend'); ?>" class="logo-mobile">
        <!-- <img src="images/icons/logo.png" alt="IMG-LOGO"> -->
        <h3>SELMA</h3>
      </a>
